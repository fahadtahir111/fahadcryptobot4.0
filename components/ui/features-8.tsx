...
export function Features() {
    return (
        <section className="bg-gray-50 py-8 md:py-16 lg:py-32 dark:bg-transparent">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-2 md:gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-4 md:pt-6 px-4 md:px-6">
                                <div className="relative flex h-20 md:h-24 w-48 md:w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-3xl md:text-5xl font-semibold">99.9%</span>
                                </div>
                                <h2 className="mt-4 md:mt-6 text-center text-xl md:text-3xl font-semibold">Uptime SLA</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-4 md:pt-6 px-4 md:px-6">
                                <div className="relative mx-auto flex aspect-square size-24 md:size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Zap className="m-auto h-fit w-8 md:w-12 text-primary" />
                                </div>
                                <div className="relative z-10 mt-4 md:mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-base md:text-lg font-medium transition dark:text-white">Real-time Signals</h2>
                                    <p className="text-sm md:text-base text-foreground">Low-latency alerts for entries, exits, and momentum shifts across markets.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-4 md:pt-6 px-4 md:px-6">
                                <div className="pt-4 md:pt-6 lg:px-6">
                                    <Lock className="w-8 md:w-10 h-8 md:h-10 text-primary mx-auto" />
                                </div>
                                <div className="relative z-10 mt-8 md:mt-14 space-y-2 text-center">
                                    <h2 className="text-base md:text-lg font-medium transition">Secure by default</h2>
                                    <p className="text-sm md:text-base text-foreground">End-to-end encryption for user sessions and chart uploads.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-4 md:pt-6 sm:grid-cols-2 px-4 md:px-6">
                                <div className="relative z-10 flex flex-col justify-between space-y-8 md:space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-10 md:size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Shield className="m-auto size-4 md:size-5" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-base md:text-lg font-medium text-zinc-800 transition dark:text-white">Risk-managed</h2>
                                        <p className="text-sm md:text-base text-foreground">Position sizing and stop-loss guidance built into every signal.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-4 md:pt-6 sm:grid-cols-2 px-4 md:px-6">
                                <div className="relative z-10 flex flex-col justify-between space-y-8 md:space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-10 md:size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Users className="m-auto size-5 md:size-6" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-base md:text-lg font-medium transition">Community-driven</h2>
                                        <p className="text-sm md:text-base text-foreground">Follow pro traders, compare playbooks, and share setups securely.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">BTC</span>
                                            <div className="ring-background size-7 ring-4">
                                                <span className="block size-full rounded-full bg-gradient-to-br from-yellow-400 to-orange-500" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <span className="block size-full rounded-full bg-gradient-to-br from-blue-400 to-purple-600" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">ETH</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">SOL</span>
                                            <div className="ring-background size-7 ring-4">
                                                <span className="block size-full rounded-full bg-gradient-to-br from-teal-400 to-emerald-500" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
